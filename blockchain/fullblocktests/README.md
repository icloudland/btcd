...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/icloudland/btcdx/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/icloudland/btcdx/blockchain/fullblocktests
```
