...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/icloudland/btcdx/netsync)
...
```bash
$ go get -u github.com/icloudland/btcdx/netsync
```
