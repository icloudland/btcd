...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/icloudland/btcdx/peer)
...
```bash
$ go get -u github.com/icloudland/btcdx/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/icloudland/btcdx/peer#example-package--NewOutboundPeer)  
